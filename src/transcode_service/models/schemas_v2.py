...
class UniversalConverterConfig(BaseModel):
    ...
    output_format: Optional[OutputFormat] = Field(default=None, description="Output format (auto-detected if None)")
    ...
    near_lossless: Optional[int] = Field(default=None, ge=0, le=100, description="WebP near lossless")
...
class UniversalTranscodeConfig(BaseModel):
    ...
    face_detection_config: Optional[Dict] = Field(default=None, description="Face detection configuration")
