...
class S3Service:
    ...
    def upload_file_from_path(self, file_path: str, key: str, custom_base_folder: str = None,
                              skip_base_folder: bool = False) -> str:
    ...
    def cleanup_task_folder_with_base_path(self, task_id: str, base_path: str) -> bool:
        ...
        try:
            ...
            if objects_deleted > 0:
                logger.info(f"Successfully cleaned up {objects_deleted} S3 objects for task {task_id} in {prefix}")
            else:
            ...
            logger.error(f"Error cleaning up S3 folder for task {task_id} with base_path {base_path}: {e}")
            return False
    ...
    def download_file(self, bucket_name_or_key: str, key_or_local_path: str, local_path: str = None) -> bool:
    ...
    def generate_output_key(self, task_id: str, profile_id: str, filename: str, s3_config: dict = None,
                            prefix: str = None, face_type: str = None) -> str:
